...
# @asset(
#     ins={"WEEKLY_ORDER_SUMMARY": AssetIn(key_prefix=["DEMO_DB2_BRANCH", "ANALYTICS"])},
...
# @asset(
#     ins={#WEEKLY_ORDER_SUMMARY
#         "weekly_order_summary": AssetIn(key_prefix=["DEMO_DB2_BRANCH", "ANALYTICS"]),
...
# @asset(
#     ins={"predicted_orders": AssetIn(key_prefix=["ANALYTICS"])},
...
#             key=AssetKey(["DEMO_DB2_BRANCH", "ANALYTICS", "WEEKLY_ORDER_SUMMARY"]),
#             dagster_type=pd.DataFrame
#             #key_prefix=["DEMO_DB2_BRANCH", "ANALYTICS"]
#         ),
#         "order_forecast_model": AssetIn(),
#     },
