...
from hooli_data_eng.pandas.assets import min_order_freshness_check, avg_orders_freshness_check
...
@dg.asset_sensor(asset_key=dg.AssetKey(["ANALYTICS", "orders_augmented"]), job=predict_job)
