...
class DataImportResource(dg.ConfigurableResource):
    ...
    def _import_to_snowflake(
        self, df: pd.DataFrame, table_name: str, snowflake_resource: SnowflakeResource
    ):
    ...
    def _import_to_duckdb(
        self, df: pd.DataFrame, table_name: str, duckdb_resource: DuckDBResource
    ):
