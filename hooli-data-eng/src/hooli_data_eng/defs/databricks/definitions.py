from hooli_data_eng.defs.databricks import assets as databricks_assets
from hooli_data_eng.defs.databricks.resources import resource_def
...
databricks_assets = dg.load_assets_from_modules(
    [databricks_assets], group_name="FORECASTING"
)
...
defs = dg.Definitions(
    assets=link_code_references_to_git_if_cloud(
        ...
        file_path_mapping=dg.AnchorBasedFilePathMapping(
            ...
            file_anchor_path_in_repository="hooli-data-eng/src/hooli_data_eng/defs/databricks/definitions.py",
        ),
    ),
