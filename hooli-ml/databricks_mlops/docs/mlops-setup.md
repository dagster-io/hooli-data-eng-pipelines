...
git add README.md docs .gitignore databricks_mlops/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://dbc-edf81ed6-5bff.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://dbc-edf81ed6-5bff.cloud.databricks.com#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[databricks_mlops/databricks.yml](../databricks_mlops/databricks.yml) file.
...
Follow the instructions in [databricks_mlops/resources/README.md](../databricks_mlops/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../databricks_mlops/resources/README.md)  to propose, test, and deploy
