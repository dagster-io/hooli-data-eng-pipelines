...
Opening a pull request will trigger a[workflow](../.github/workflows/databricks_mlops-run-tests.yml) 
...
Links:
* [Staging model in UC](https://dbc-edf81ed6-5bff.cloud.databricks.com/explore/data/models/staging/databricks_mlops/databricks_mlops-model)
* [Prod model in UC](https://dbc-edf81ed6-5bff.cloud.databricks.com/explore/data/models/prod/databricks_mlops/databricks_mlops-model)
. 
